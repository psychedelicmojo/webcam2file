...
class TestErrorManagerUnit:
    ...
    def test_get_recovery_action(self):
        ...
        assert self.error_manager.get_recovery_action('WebcamNotFoundError') == 'Connect webcam'
        assert self.error_manager.get_recovery_action('WebcamAccessError') == 'Close other apps'
        assert self.error_manager.get_recovery_action('FolderNotFoundError') == 'Select valid folder'
        assert self.error_manager.get_recovery_action('FolderAccessError') == 'Check permissions'
        assert self.error_manager.get_recovery_action('APIConnectionError') == 'Start ComfyUI'
    ...
    def test_get_recovery_action_unknown_error(self):
        ...
        assert self.error_manager.get_recovery_action('UnknownError') == 'Retry operation'
