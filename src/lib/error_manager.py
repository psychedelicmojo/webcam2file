...
class ErrorManager:
    ...
    ERROR_DEFINITIONS: Dict[str, Dict[str, str]] = {
        ...
        'WebcamAccessError': {
            'user_message': 'Cannot access webcam. Close other applications using the webcam and try again.',
        ...
        'APIConnectionError': {
            'user_message': 'Cannot connect to ComfyUI. Make sure ComfyUI is running and try again.',
            'recovery_action': 'Start ComfyUI',
        },
        'APIError': {
            'user_message': 'ComfyUI returned an error. Check the workflow configuration and try again.',
            'recovery_action': 'Check workflow',
        },
        'TimeoutError': {
            'user_message': 'Request to ComfyUI timed out. Check your network connection and try again.',
