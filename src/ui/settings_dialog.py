...
class SettingsDialog:
    ...
    def __init__(
        ...
        self._dialog.geometry("700x1100")
    ...
    def _build_ui(self) -> None:
        ...
        self._email_address_entry.grid(row=14, column=1, sticky="ew", pady=5, padx=5)
        ...
        self._apps_script_url_entry.grid(row=15, column=1, sticky="ew", pady=5, padx=5)
        ttk.Label(
            main_frame,
        ...
        self._api_timeout_entry.grid(row=16, column=1, sticky="w", pady=5, padx=5)
        ...
        self._countdown_entry.grid(row=17, column=1, sticky="w", pady=5, padx=5)
        ttk.Label(
        ...
        self._status_label.grid(row=18, column=0, columnspan=3, pady=10)

        # Buttons frame
        buttons_frame = ttk.Frame(main_frame)
        buttons_frame.grid(row=19, column=0, columnspan=3, pady=10)
