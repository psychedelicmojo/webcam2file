...
def test_opencv_to_pil():
    ...
    print(f"  PASSED: Converted to PIL Image mode={pil_image.mode}, size={pil_image.size}")
    return True
...
def test_pil_to_photoimage():
    ...
    try:
        ...
        print(f"  PASSED: Created PhotoImage")
        return True
...
def test_full_integration():
    ...
    try:
        ...
        print(f"  PASSED: Displayed frame in Tkinter label")
...
def test_webcam_with_opencv():
    ...
    print(f"  PASSED: Captured 3 frames successfully")
    cap.release()
    return True
